...
if (!empty($_POST['Nume'])) {
    ...
    if (!empty($_POST['Telefon']))
        $sql = "UPDATE Furnizori SET Telefon='". $adds['Telefon']. "' WHERE Nume='". $adds['Nume']. "'";
    if (!empty($_POST['Email']))
        $sql = "UPDATE Furnizori SET Email='". $adds['Email']. "' WHERE Nume='". $adds['Nume']. "'";
    if (!empty($_POST['Telefon']) && !empty($_POST['Email']))
        $sql = "UPDATE Furnizori SET Telefon='". $adds['Telefon']. "', Email='". $adds['Email']. "' WHERE Nume='". $adds['Nume']. "'";
